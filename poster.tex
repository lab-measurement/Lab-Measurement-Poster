...
/ Agilent, Rigol
\item Nanonis Tramea; AH2700A capacitance bridge
\item and many more...
\end{itemize}
}
\vspace*{1cm}
...
\vspace*{2cm}
  ...
  \item
    Rigol DSA815, HP 8596E Spectrum Analyzer
  \item
    Keithley 2400, Keysight B2901A ``sourcemeter''
  \item
...
\item 
 Compatibility with newer versions of Zurich Instruments LabOne API
\end{itemize}
