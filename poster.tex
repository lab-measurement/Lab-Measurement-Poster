...
\vspace*{2cm}
  ...
  \begin{itemize}
  \item
  VISA::USB connection: USB-TMC over NI-VISA
  \item
  Enable magnet persistent mode usage
  \item
  ...
  \item
  SignalRecovery 7265, Zurich Instruments HF2LI, Synctek MCL1-540 lock-in
  \item
  ...
  \item
  Tektronix TBS1000C, Keysight DSOS604A oscilloscope
  \item
  Rigol DG5000 series waveform generator
  \item
  Rohde \& Schwarz ZNL network analyzer
  \item
  Nanonis Tramea (work in progress)
  \end{itemize}
\end{itemize}
