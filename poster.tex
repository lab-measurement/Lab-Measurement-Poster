...
Ferromagnetic resonance measurement with Vector Network Analyzer (VNA).
 \item
Outer loop: Continuous sweep of the magnetic field with OI Mercury iPS
 \item 
Inner loop: Measure transmission at set of microwave frequencies with VNA
\end{itemize}
...
\vspace*{2cm}
\begin{itemize}
\item \emph{META.yml:} Various metadata (host, user, date, version,
