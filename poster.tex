...
\item \emph{data.dat.plot.png:} live plot at end of measurement as a png image
...
\vspace*{-1cm}
\begin{itemize}
\item Multidimensional sweeps, e.g. 3D sweep: create one 2D datafile for each
...
\heading{Instrument / connection layers}
...
grant Hu1808/1, SFB 689, and GRK 1570.
\end{center}
