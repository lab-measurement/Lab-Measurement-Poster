...
Ferromagnetic resonance measurement with Vector Network Analyzer (VNA)
 \item
Outer loop: Continuous sweep of magnetic field with OI Mercury iPS magnet controller
 \item 
...
\item {\lightblue New drivers}: OI Mercury magnet controller and level meter
  sensor; Zurich Instruments MFLI lock-in amplifier and MFIA impedance analyzer
\item {\lightblue New connection backends}
  ...
  \item USB-TMC, VXI-11: Lightweight user space drivers for Linux/Unix.
    ...
    reliablitiy as based on standard system libraries (libusb, sunrpc)
...
\item {\lightblue New high-level Sweep framework:} Modern Perl
  implementation; use state of the art object orientated programming
  \vspace*{0.5cm}
